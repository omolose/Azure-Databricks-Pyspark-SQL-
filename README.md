...
| Key Terms | Definition of terms | Documentation Sources |
| ----------- | ----------- |  ----------- |
| Local Temp View, Global Temp View and Tables | N/A |  [Docs](https://sparkbyexamples.com/spark/spark-createorreplacetempview-explained/#:~:text=So%20if%20you%20are%20comfortable,is%20not%20materialized%20into%20files)|
